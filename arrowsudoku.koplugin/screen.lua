...
local ArrowSudokuBoardWidget = lrequire("board_widget")
...
function ArrowSudokuScreen:buildLayout()
    ...
    self.board_widget = ArrowSudokuBoardWidget:new{
        board              = self.board,
...
function ArrowSudokuScreen:updateStatus(message)
    local status
    if message then
        status = message
    else
