...
function BetweenLinesScreen:buildLayout()
    ...
    self.board_widget = BetweenLinesBoardWidget:new{
        board              = self.board,
...
function BetweenLinesScreen:updateStatus(message)
    local status
    if message then
        status = message
    else
